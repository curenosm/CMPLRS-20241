...
allLessThan root (Node v l r) =
  v < root && allLessThan root l && allLessThan root r

allGreaterThan :: Int -> BST Int -> Bool
allGreaterThan _ Empty = True
allGreaterThan root (Node v l r) =
  v > root && allGreaterThan root l && allGreaterThan root r
